...
class Encryptor(object):
    ...
    def _is_file_name_legal(self, orig_file, new_file):
        ...
        if not self._does_file_exists(orig_file): sys.exit("[+] The file could not be located, exiting program!!!")
    ...
    def _does_file_exists(self, file_name):
        """_does_file_exists(str) -> return(value)
